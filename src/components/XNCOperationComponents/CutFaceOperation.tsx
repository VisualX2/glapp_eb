...
export const CutFaceOperation: React.FC<CutFaceParameters> = observer(({angle,side,partwidth,partheight,partdepth}) => {
    ...
    const bC = () => {
        if (side === "left") {
            ...
            return <Group><Line points={[partwidth - dist,0,partwidth - dist,partheight]} stroke="red" dash={[5,2]}></Line></Group>
        }
        else if(side === "top"){
            return <Group><Line points={[0,dist,partwidth,dist]} stroke="red" dash={[5,2]}></Line></Group>
        }
        else{
            return <Group><Line points={[0,partheight - dist,partwidth,partheight - dist]} stroke="red" dash={[5,2]}></Line></Group>
        }
    }
